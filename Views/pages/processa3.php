    ...
    >
      ...
      <tr>
        <tr>
          <td>
            <h2 style="text-transform: uppercase; text-align: center; line-height: 1.5rem; font-size: 1rem; color: #023bbf; font-family: Verdana; font-weight: bolder; padding: 1rem 3rem 0 3rem;">ACESSE NOSSO SISTEMA CLICANDO NO BOTÃO A SEGUIR PARA CONCLUIR O CADASTRO DA PROPOSTA</h2>
          </td>
        </tr>
            ...
            <tr style="height: 3rem; align-items: center; width: 100%;">
              <td>
                <a href="#" style="text-decoration: none; color: none;">
                  <button style="text-transform: uppercase; font-weight: 500; padding: 5px 14px; border-radius: .5rem; border: none; background-color: #023bbf; color: #ffffff; line-height: 1.25rem; font-size: .8rem; cursor: pointer; box-shadow: 0 0 .15rem black; text-align: center;">Clique Aqui</button>
                </a>
              </td>
            </tr>
          </table>
