    ...
    >
      ...
      <tr>
        <tr>
          <td>
            <h2 style="text-transform: uppercase; text-align: center; line-height: 1.5rem; font-size: 1rem; color: #023bbf; font-family: Verdana; font-weight: bolder; padding: 1rem 3rem 0 3rem;">SEGUE O LINK PARA MUDANÇA DE SENHA</h2>
          </td>
        </tr>
