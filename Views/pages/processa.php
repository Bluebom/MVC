    ...
    >
      ...
      <tr>
        <tr>
          <td>
            <h2 style="text-transform: uppercase; text-align: center; line-height: 1.5rem; font-size: 1rem; color: #023bbf; font-family: Verdana; font-weight: bolder; padding: 1rem 3rem 0 3rem;">acesse nosso sistema com os dados a seguir para concluir o cadastro da proposta</h2>
          </td>
        </tr>
        <!-- <tr>
          <td>
          ...
          >
            <tr style="height: 3rem; width: 100%;">
              <td style="line-height: 1.5rem; font-size: 1rem; text-align: center;">
                <span style="text-transform: uppercase; font-weight: bold; color: #023bbf;">email:</span> exemplo email
              </td>
            </tr>
            <tr style="height: 3rem; width: 100%;">
              <td style="line-height: 1.5rem; font-size: 1rem; text-align: center;">
                <span style="text-transform: uppercase; font-weight: bold; color: #023bbf;">senha:</span> exemplo senha
              </td>
            </tr>
            <tr style="height: 3rem; align-items: center; width: 100%;">
              <td>
                <a href="#" style="text-decoration: none; color: none;">
                  <button style="text-transform: uppercase; font-weight: 500; padding: 5px 14px; border-radius: .5rem; border: none; background-color: #023bbf; color: #ffffff; line-height: 1.25rem; font-size: .8rem; cursor: pointer; box-shadow: 0 0 .15rem black; text-align: center;">Concluir Proposta</button>
                </a>
              </td>
            </tr>
          </table>
      ...
      <tr>
        <td>
          <h3 style="letter-spacing: -.025rem; color: #2b2b2b; text-transform: uppercase ;text-align: center; padding: 0 10px; font-size: .9rem; font-family: Arial, Helvetica, sans-serif;margin: .5rem 0;">Agradecemos a sua escolha!</h3>
        </td>
      </tr>
      <tr>
        <td bgcolor="#2b2b2b">
